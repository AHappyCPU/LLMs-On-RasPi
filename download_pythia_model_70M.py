...
def download_pythia():
    """Download Pythia model files"""
    cache_dir = os.path.expanduser("~/.cache/huggingface/hub/models--EleutherAI--pythia-70m")
    os.makedirs(cache_dir, exist_ok=True)
    
    # Download config and tokenizer
    base_url = "https://huggingface.co/EleutherAI/pythia-70m/resolve/main"
    files_to_download = [
        "config.json",
        "tokenizer.json",
